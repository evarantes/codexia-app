...
def _build_checkpoint(generator: Any, segmented: Dict[str, Any], kwargs: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    checkpoint: Dict[str, Any] = {
        ...
        "caption_timeline": list(segmented.get("caption_timeline") or []),
        "caption_alignment_exact": bool(segmented.get("caption_alignment_exact")),
        "caption_timing_source": segmented.get("caption_timing_source"),
